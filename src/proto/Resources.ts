...
export const StringPool: MessageFns<StringPool> = {
  encode(message: StringPool, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): StringPool {
  ...
  toJSON(message: StringPool): object {
    const obj: any = {};
    if (message.data.length !== 0) {
...
export const SourcePosition: MessageFns<SourcePosition> = {
  ...
  toJSON(message: SourcePosition): object {
    const obj: any = {};
    if (message.lineNumber !== 0) {
...
export const ToolFingerprint: MessageFns<ToolFingerprint> = {
  encode(message: ToolFingerprint, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.tool !== '') {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ToolFingerprint {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: ToolFingerprint): object {
    const obj: any = {};
    if (message.tool !== '') {
...
export const ResourceTable: MessageFns<ResourceTable> = {
  encode(message: ResourceTable, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sourcePool !== undefined) {
      StringPool.encode(message.sourcePool, writer.uint32(10).fork()).join();
    }
    for (const v of message.package) {
      Package.encode(v!, writer.uint32(18).fork()).join();
    }
    for (const v of message.overlayable) {
      Overlayable.encode(v!, writer.uint32(26).fork()).join();
    }
    for (const v of message.toolFingerprint) {
      ToolFingerprint.encode(v!, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ResourceTable {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: ResourceTable): object {
    const obj: any = {};
    if (message.sourcePool !== undefined) {
...
export const PackageId: MessageFns<PackageId> = {
  ...
  toJSON(message: PackageId): object {
    const obj: any = {};
    if (message.id !== 0) {
...
export const Package: MessageFns<Package> = {
  encode(message: Package, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.packageId !== undefined) {
      PackageId.encode(message.packageId, writer.uint32(10).fork()).join();
    }
    if (message.packageName !== '') {
      writer.uint32(18).string(message.packageName);
    }
    for (const v of message.type) {
      Type.encode(v!, writer.uint32(26).fork()).join();
    }
    return writer;
  },
...
export const TypeId: MessageFns<TypeId> = {
  encode(message: TypeId, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== 0) {
      writer.uint32(8).uint32(message.id);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TypeId {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Type: MessageFns<Type> = {
  encode(message: Type, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.typeId !== undefined) {
      TypeId.encode(message.typeId, writer.uint32(10).fork()).join();
    }
    if (message.name !== '') {
...
function createBaseVisibility(): Visibility {
  return { level: 0, source: undefined, comment: '' };
}
...
export const Visibility: MessageFns<Visibility> = {
  ...
  toJSON(message: Visibility): object {
    const obj: any = {};
    if (message.level !== 0) {
...
export const AllowNew: MessageFns<AllowNew> = {
  encode(message: AllowNew, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.source !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AllowNew {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: AllowNew): object {
    const obj: any = {};
    if (message.source !== undefined) {
      obj.source = Source.toJSON(message.source);
    }
...
export const Overlayable: MessageFns<Overlayable> = {
  encode(message: Overlayable, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== '') {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Overlayable {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: Overlayable): object {
    const obj: any = {};
    if (message.name !== '') {
      obj.name = message.name;
    }
...
export const OverlayableItem: MessageFns<OverlayableItem> = {
  encode(message: OverlayableItem, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.source !== undefined) {
      Source.encode(message.source, writer.uint32(10).fork()).join();
    }
    if (message.comment !== '') {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): OverlayableItem {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: OverlayableItem): object {
    const obj: any = {};
    if (message.source !== undefined) {
      obj.source = Source.toJSON(message.source);
    }
...
export const EntryId: MessageFns<EntryId> = {
  encode(message: EntryId, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== 0) {
      writer.uint32(8).uint32(message.id);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EntryId {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Entry: MessageFns<Entry> = {
  encode(message: Entry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.entryId !== undefined) {
      EntryId.encode(message.entryId, writer.uint32(10).fork()).join();
    }
    if (message.name !== '') {
      writer.uint32(18).string(message.name);
    }
    if (message.visibility !== undefined) {
      Visibility.encode(message.visibility, writer.uint32(26).fork()).join();
    }
    if (message.allowNew !== undefined) {
      AllowNew.encode(message.allowNew, writer.uint32(34).fork()).join();
    }
    if (message.overlayableItem !== undefined) {
      OverlayableItem.encode(message.overlayableItem, writer.uint32(42).fork()).join();
    }
    for (const v of message.configValue) {
      ConfigValue.encode(v!, writer.uint32(50).fork()).join();
    }
    return writer;
  },
...
export const ConfigValue: MessageFns<ConfigValue> = {
  encode(message: ConfigValue, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.config !== undefined) {
      Configuration.encode(message.config, writer.uint32(10).fork()).join();
    }
  ...
  toJSON(message: ConfigValue): object {
    const obj: any = {};
    if (message.config !== undefined) {
...
export const Value: MessageFns<Value> = {
  encode(message: Value, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.compoundValue !== undefined) {
      CompoundValue.encode(message.compoundValue, writer.uint32(42).fork()).join();
    }
    return writer;
  },
...
export const Item: MessageFns<Item> = {
  encode(message: Item, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.ref !== undefined) {
      Reference.encode(message.ref, writer.uint32(10).fork()).join();
    }
    if (message.str !== undefined) {
      String.encode(message.str, writer.uint32(18).fork()).join();
    }
    if (message.rawStr !== undefined) {
      RawString.encode(message.rawStr, writer.uint32(26).fork()).join();
    }
    if (message.styledStr !== undefined) {
      StyledString.encode(message.styledStr, writer.uint32(34).fork()).join();
    }
    if (message.file !== undefined) {
      FileReference.encode(message.file, writer.uint32(42).fork()).join();
    }
    if (message.id !== undefined) {
      Id.encode(message.id, writer.uint32(50).fork()).join();
    }
    if (message.prim !== undefined) {
      Primitive.encode(message.prim, writer.uint32(58).fork()).join();
    }
    return writer;
  },
...
function createBaseCompoundValue(): CompoundValue {
  return { attr: undefined, style: undefined, styleable: undefined, array: undefined, plural: undefined };
}

export const CompoundValue: MessageFns<CompoundValue> = {
  encode(message: CompoundValue, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.attr !== undefined) {
      Attribute.encode(message.attr, writer.uint32(10).fork()).join();
    }
    if (message.style !== undefined) {
      Style.encode(message.style, writer.uint32(18).fork()).join();
    }
    if (message.styleable !== undefined) {
      Styleable.encode(message.styleable, writer.uint32(26).fork()).join();
    }
    if (message.array !== undefined) {
      Array.encode(message.array, writer.uint32(34).fork()).join();
    }
    if (message.plural !== undefined) {
      Plural.encode(message.plural, writer.uint32(42).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CompoundValue {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: CompoundValue): object {
    const obj: any = {};
    if (message.attr !== undefined) {
...
function createBaseReference(): Reference {
  return { type: 0, id: 0, name: '', private: false };
}
...
export const Reference: MessageFns<Reference> = {
  ...
  toJSON(message: Reference): object {
    const obj: any = {};
    if (message.type !== 0) {
...
export const Id: MessageFns<Id> = {
  encode(_: Id, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const RawString: MessageFns<RawString> = {
  encode(message: RawString, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.value !== '') {
      writer.uint32(10).string(message.value);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RawString {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: RawString): object {
    const obj: any = {};
    if (message.value !== '') {
      obj.value = message.value;
    }
...
export const StyledString: MessageFns<StyledString> = {
  encode(message: StyledString, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.value !== '') {
      writer.uint32(10).string(message.value);
    }
    for (const v of message.span) {
      StyledString_Span.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): StyledString {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: StyledString): object {
    const obj: any = {};
    if (message.value !== '') {
      obj.value = message.value;
    }
...
export const StyledString_Span: MessageFns<StyledString_Span> = {
  encode(message: StyledString_Span, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.tag !== '') {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): StyledString_Span {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: StyledString_Span): object {
    const obj: any = {};
    if (message.tag !== '') {
      obj.tag = message.tag;
    }
...
export const FileReference: MessageFns<FileReference> = {
  ...
  toJSON(message: FileReference): object {
    const obj: any = {};
    if (message.path !== '') {
...
export const Primitive: MessageFns<Primitive> = {
  encode(message: Primitive, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.nullValue !== undefined) {
      Primitive_NullType.encode(message.nullValue, writer.uint32(10).fork()).join();
    }
    if (message.emptyValue !== undefined) {
      Primitive_EmptyType.encode(message.emptyValue, writer.uint32(18).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Primitive {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: Primitive): object {
    const obj: any = {};
    if (message.nullValue !== undefined) {
...
export const Primitive_NullType: MessageFns<Primitive_NullType> = {
  encode(_: Primitive_NullType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Primitive_NullType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(_: Primitive_NullType): object {
    return {};
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Primitive_NullType>, I>>(_: I): Primitive_NullType {
    return createBasePrimitive_NullType();
  },
};
...
export const Primitive_EmptyType: MessageFns<Primitive_EmptyType> = {
  encode(_: Primitive_EmptyType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Primitive_EmptyType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(_: Primitive_EmptyType): object {
    return {};
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Primitive_EmptyType>, I>>(_: I): Primitive_EmptyType {
    return createBasePrimitive_EmptyType();
  },
};
...
export const Attribute: MessageFns<Attribute> = {
  encode(message: Attribute, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.symbol) {
      Attribute_Symbol.encode(v!, writer.uint32(34).fork()).join();
    }
    return writer;
  },
  ...
  toJSON(message: Attribute): object {
    const obj: any = {};
    if (message.formatFlags !== 0) {
...
export const Attribute_Symbol: MessageFns<Attribute_Symbol> = {
  encode(message: Attribute_Symbol, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.source !== undefined) {
      Source.encode(message.source, writer.uint32(10).fork()).join();
    }
    if (message.comment !== '') {
    ...
    if (message.name !== undefined) {
      Reference.encode(message.name, writer.uint32(26).fork()).join();
    }
    if (message.value !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Attribute_Symbol {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: Attribute_Symbol): object {
    const obj: any = {};
    if (message.source !== undefined) {
      obj.source = Source.toJSON(message.source);
    }
...
export const Style: MessageFns<Style> = {
  encode(message: Style, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.parent !== undefined) {
      Reference.encode(message.parent, writer.uint32(10).fork()).join();
    }
    if (message.parentSource !== undefined) {
      Source.encode(message.parentSource, writer.uint32(18).fork()).join();
    }
    for (const v of message.entry) {
      Style_Entry.encode(v!, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Style {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Style_Entry: MessageFns<Style_Entry> = {
  encode(message: Style_Entry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.source !== undefined) {
      Source.encode(message.source, writer.uint32(10).fork()).join();
    }
    if (message.comment !== '') {
    ...
    if (message.key !== undefined) {
      Reference.encode(message.key, writer.uint32(26).fork()).join();
    }
    if (message.item !== undefined) {
      Item.encode(message.item, writer.uint32(34).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Style_Entry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: Style_Entry): object {
    const obj: any = {};
    if (message.source !== undefined) {
      obj.source = Source.toJSON(message.source);
    }
...
export const Styleable: MessageFns<Styleable> = {
  encode(message: Styleable, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.entry) {
      Styleable_Entry.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Styleable {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: Styleable): object {
    const obj: any = {};
    if (message.entry?.length) {
...
export const Styleable_Entry: MessageFns<Styleable_Entry> = {
  encode(message: Styleable_Entry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.source !== undefined) {
      Source.encode(message.source, writer.uint32(10).fork()).join();
    }
    if (message.comment !== '') {
    ...
    if (message.attr !== undefined) {
      Reference.encode(message.attr, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Styleable_Entry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: Styleable_Entry): object {
    const obj: any = {};
    if (message.source !== undefined) {
      obj.source = Source.toJSON(message.source);
    }
...
export const Array: MessageFns<Array> = {
  encode(message: Array, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.element) {
      Array_Element.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },
...
export const Array_Element: MessageFns<Array_Element> = {
  encode(message: Array_Element, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.source !== undefined) {
      Source.encode(message.source, writer.uint32(10).fork()).join();
    }
    if (message.comment !== '') {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Array_Element {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: Array_Element): object {
    const obj: any = {};
    if (message.source !== undefined) {
      obj.source = Source.toJSON(message.source);
    }
...
export const Plural: MessageFns<Plural> = {
  encode(message: Plural, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.entry) {
      Plural_Entry.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Plural {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Plural_Entry: MessageFns<Plural_Entry> = {
  encode(message: Plural_Entry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.source !== undefined) {
      Source.encode(message.source, writer.uint32(10).fork()).join();
    }
    if (message.comment !== '') {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Plural_Entry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: Plural_Entry): object {
    const obj: any = {};
    if (message.source !== undefined) {
      obj.source = Source.toJSON(message.source);
    }
...
export const XmlNode: MessageFns<XmlNode> = {
  encode(message: XmlNode, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.element !== undefined) {
      XmlElement.encode(message.element, writer.uint32(10).fork()).join();
    }
    if (message.text !== undefined) {
      writer.uint32(18).string(message.text);
    }
    if (message.source !== undefined) {
      SourcePosition.encode(message.source, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): XmlNode {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const XmlElement: MessageFns<XmlElement> = {
  encode(message: XmlElement, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.namespaceDeclaration) {
      XmlNamespace.encode(v!, writer.uint32(10).fork()).join();
    }
    ...
    for (const v of message.attribute) {
      XmlAttribute.encode(v!, writer.uint32(34).fork()).join();
    }
    for (const v of message.child) {
      XmlNode.encode(v!, writer.uint32(42).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): XmlElement {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: XmlElement): object {
    const obj: any = {};
...
export const XmlNamespace: MessageFns<XmlNamespace> = {
  encode(message: XmlNamespace, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.prefix !== '') {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): XmlNamespace {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: XmlNamespace): object {
    const obj: any = {};
    if (message.prefix !== '') {
...
export const XmlAttribute: MessageFns<XmlAttribute> = {
  encode(message: XmlAttribute, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.namespaceUri !== '') {
    ...
    if (message.source !== undefined) {
      SourcePosition.encode(message.source, writer.uint32(34).fork()).join();
    }
    if (message.resourceId !== 0) {
      writer.uint32(40).uint32(message.resourceId);
    }
    if (message.compiledItem !== undefined) {
      Item.encode(message.compiledItem, writer.uint32(50).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): XmlAttribute {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: XmlAttribute): object {
    const obj: any = {};
    if (message.namespaceUri !== '') {
      obj.namespaceUri = message.namespaceUri;
    }
